...
$q1=mysql_query(sql([
 ...
 'from' => ['courses left join lessons on courses.idCourse=lessons.idCourse left join teachers t on courses.idTeacher=t.idTeacher  left join teachers t2 on courses.idTeacher2=t2.idTeacher left join Course_Listeners on courses.idCourse=Course_Listeners.idCourse left join listeners on listeners.idListener=Course_Listeners.idListener'],
...
while ($result=mysql_fetch_array($q1, MYSQL_ASSOC)){
 ...
 $result=array_diff_key($result, array_flip(['tSurname', 'tName', 'tPatronymic', 't2Surname', 't2Name', 't2Patronymic', 'lSurname', 'lName', 'lPatronymic']));
